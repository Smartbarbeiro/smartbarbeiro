...
Write-Host "  laravel.zip     -> /laravel/"
Write-Host "  public_html.zip -> /public_html/"
Write-Host ""
Write-Host "FTP host: ftp.fulviolopescatto1787174444000.0970020.meusitehostgator.com.br"
Write-Host "FTP user: fulvio@fulviolopescatto1787174444000.0970020.meusitehostgator.com.br"
...
Write-Host "  2. Visit extract-deploy-tesora.php (skips laravel/storage/app/public/,"
Write-Host "     backs up + restores public_html/images/)"
Write-Host "  3. patch-mp-production-tesora.php, clear-cache-tesora.php, setup-tesora.php"
Write-Host ""
...
Write-Host "  extract-deploy-tesora.php, sync-laravel-tesora.php, sync-build-tesora.php, fix-env-format-tesora.php, fix-vite-tesora.php"
Write-Host "  setup-tesora.php, patch-mp-production-tesora.php"
Write-Host "Delete all *-tesora.php helpers from public_html after deploy."
