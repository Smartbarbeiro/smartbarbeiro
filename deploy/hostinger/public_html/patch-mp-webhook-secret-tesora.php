 ...
 * Visit once with: ?key=tesora-mp-webhook-2026&secret=YOUR_SECRET
...
$expectedKey = 'tesora-mp-webhook-2026';
$key = (string) ($_GET['key'] ?? '');
...
echo "DELETE patch-mp-webhook-secret-tesora.php when done.\n";
