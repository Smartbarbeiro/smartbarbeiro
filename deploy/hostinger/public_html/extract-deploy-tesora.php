 ...
 *
 * Visit once: https://www.tesora.com.br/extract-deploy-tesora.php
...
try {
    ...
    echo "Next:\n";
    echo "1. patch-mp-production-tesora.php\n";
    echo "2. clear-cache-tesora.php\n";
    echo "3. setup-tesora.php\n";
    echo "\nDELETE extract-deploy-tesora.php when done.\n";
} catch (Throwable $e) {
