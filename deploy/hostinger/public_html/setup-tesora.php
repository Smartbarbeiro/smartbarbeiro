 ...
 * https://www.tesora.com.br/setup-tesora.php
...
try {
    ...
    if (! is_file($laravelRoot.'/.env')) {
        throw new RuntimeException('.env missing. Run env-setup-tesora.php first.');
    }
    ...
    echo "Setup finished.\n";
    echo "Test: https://www.tesora.com.br\n";
    echo "If the homepage still fails, open:\n";
    echo "https://www.tesora.com.br/?debug=tesora-setup-2026\n";
    echo "\nDELETE setup-tesora.php when done.\n";
} catch (Throwable $e) {
