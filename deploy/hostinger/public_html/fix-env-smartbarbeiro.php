...
// https://www.smartbarbeiro.com.br/fix-env-smartbarbeiro.php
...
echo "  APP_DEBUG=true\n\n";
echo "Run clear-cache-smartbarbeiro.php then test-smartbarbeiro.php\n";
echo "DELETE fix-env-smartbarbeiro.php when done.\n";
