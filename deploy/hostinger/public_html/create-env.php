 ...
 * Visit once: /create-env.php?key=tesora-setup-2026
...
if (! isset($_GET['key']) || ! hash_equals($secret, (string) $_GET['key'])) {
    ...
    echo '<p><a href="?key=tesora-setup-2026">create-env.php?key=tesora-setup-2026</a></p>';
    echo '<p>Or upload <strong>env-setup-tesora.php</strong> and open it (no key needed).</p>';
    exit;
}
