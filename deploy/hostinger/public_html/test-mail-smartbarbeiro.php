 ...
 *
 * Visit once:
 *   https://www.smartbarbeiro.com.br/test-mail-smartbarbeiro.php?key=smartbarbeiro-mail-2026&to=you@example.com
 *
...
try {
    Illuminate\Support\Facades\Mail::raw(
        "Teste SMTP Smart Barbeiro em ".now()->toDateTimeString().".\n\nSe você recebeu este e-mail, o SMTP está configurado corretamente.",
        function ($message) use ($to) {
            $message->to($to)->subject('Smart Barbeiro — teste SMTP');
        },
    );
...
echo "\nDELETE test-mail-smartbarbeiro.php when done.\n";
