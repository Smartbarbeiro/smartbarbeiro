 ...
 * Visit: https://www.tesora.com.br/storage-status-tesora.php
...
echo "\nIf file_on_disk=yes but avatar broken, run fix-storage-link-tesora.php\n";
echo "DELETE storage-status-tesora.php when done.\n";
